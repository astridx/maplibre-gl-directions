...
-   [MapLibreDirections](#maplibredirections)
    -   [onRemove](#onremove)
...
-   `options` **[Object](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object)** 
    ...
    -   `options.profile` **[String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** Routing profile to use. Options: `mapbox/driving-traffic`, `mapbox/driving`, `mapbox/walking`, `mapbox/cycling` (optional, default `"driving"`)
...
Returns **[MapLibreDirections](#maplibredirections)** `this`
